function About() {
    return (
        <div>
            <h2>Sobre Mim</h2>
            <p>Olá, me chamo João Vitor, estudante autodidata de desenvolvimento web front-end.</p>
            <p>Aqui irei mostrar minhas habilidades e projetos práticos que fiz durante minha jornada de aprendizado.</p>
            <ul>
