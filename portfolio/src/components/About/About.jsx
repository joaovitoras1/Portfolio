function About() {
    return (
        <div className="p-10 place-items-center font-open-sans">
            <h2 className="pb-5 text-[20px] text-center text-(--white)">Sobre Mim</h2>
            <p className="text-justify text-(--lavender-gray)">Olá, me chamo João Vitor, estudante autodidata de desenvolvimento web front-end. Aqui irei mostrar minhas habilidades e projetos práticos que fiz durante minha jornada de aprendizado.</p>
            <ul className="flex flex-col gap-2 p-5 list-disc text-justify text-(--lavender-gray)">
